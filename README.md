...
・パスワード:a1a1a1<br>
# 制作背景
私は多くの人が地方に足を運んでもらうことで、地方の人口減少の問題、地方の活性化に繋がるとうい狙いでこのアプリケーションを制作しました。<br>
私自身、５年間高知県に住んでいましたが、本当に多くの魅力を感じました。同時に、人口減少、高齢化に伴う財政の厳しさも感じました。<br>
この問題を解決するには、まず足を運んでもらうことから始まるのではないかと考えています。<br>
...
必要項目を入力後登録ボタンをクリックすることでユーザー情報が登録されます。<br>
...
マイページボタンをクリックすると自身のユーザー情報表示ページに遷移します。<br>
...
編集箇所の入力を行い、投稿をクリックすると投稿詳細ページに遷移します。<br>
...
### エディタ
 VSCode
## 課題や今後実装したい機能
写真を一枚しか投稿できないという課題があります。そのため、今後の追加機能として複数の写真表示をどのようにするとユーザーが分かりやすいのかを第一に、実装を考えています。<br>
また、エラーハンドリングを表示させていません。JavaScriptを使ったものを考えていますので、その点も学習が必要だと考えています。<br>
実装したい機能として、訪れた都道府県をチェックする機能を考えています。地方に行ってもらうという点で、ユーザーがより足を運んでもらえる機能になると考えています。
# テーブル設計
